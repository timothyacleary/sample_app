...
describe User do
  ...
  describe "with admin property true" do
    before do
      @user.save!
      @user.toggle!(:admin)
    end
  ...
  describe "Micropost assocations" do
    ...
    it "should destroy associated mps" do
      # create shallow copy of @user's microposts
      microposts = @user.microposts.dup
      @user.destroy
      # the duplicate array should still be there
      microposts.should_not be_empty
      microposts.each do |mp|
        # check that the originals have been destroyed from database
